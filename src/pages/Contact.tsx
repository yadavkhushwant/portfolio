          ...
          <div>
              ...
              <div className="bg-white dark:bg-gray-800 rounded-lg shadow-lg p-6">
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <a 
                      href="mailto:yadavkhushwant777@gmail.com"
              ...
              <div className="bg-white dark:bg-gray-800 rounded-lg shadow-lg p-6">
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600 dark:text-gray-400 mb-2">
                      Available for calls Monday to Friday, 9 AM to 6 PM IST.
                    </p>
                    <a 
                      href="tel:+918858013899"
                      className="text-blue-600 dark:text-blue-400 hover:underline"
                    >
                      +91 8858013899
                    </a>
              ...
              <div className="bg-white dark:bg-gray-800 rounded-lg shadow-lg p-6">
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600 dark:text-gray-400 mb-2">
                      Currently based in Kushinagar, UP. Open to remote opportunities worldwide.
                    </p>
            ...
            <div className="mt-8">
              ...
              <div className="flex space-x-4">
                <a
                  href="https://linkedin.com/in/khushwant-yadav"
                  target="_blank"
                ...
                <a
                  href="https://github.com/khushwant-yadav"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="w-12 h-12 bg-gray-800 dark:bg-gray-600 rounded-lg flex items-center justify-center text-white hover:bg-gray-900 dark:hover:bg-gray-500 transition-colors duration-200"
          ...
          <div className="text-center">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mt-8">
              <div className="text-center">
                ...
                <h3 className="font-semibold text-gray-900 dark:text-white mb-2">Fast Response</h3>
                <p className="text-gray-600 dark:text-gray-400 text-sm">I typically respond to all inquiries within 24 hours</p>
              </div>
              <div className="text-center">
                <div className="w-16 h-16 bg-blue-100 dark:bg-blue-800 rounded-full flex items-center justify-center mx-auto mb-4">
                  <span className="text-2xl">🤝</span>
                ...
                <p className="text-gray-600 dark:text-gray-400 text-sm">Detailed consultation and project planning assistance</p>
              </div>
              <div className="text-center">
                <div className="w-16 h-16 bg-blue-100 dark:bg-blue-800 rounded-full flex items-center justify-center mx-auto mb-4">
                  <span className="text-2xl">🎯</span>
                ...
                <p className="text-gray-600 dark:text-gray-400 text-sm">Transparent discussion about timelines and requirements</p>
              </div>
            </div>
          </div>
        </div>
